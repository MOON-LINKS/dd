...
CREATE TABLE users (
    ...
    subscription_tier ENUM('solo_monthly','solo_yearly') NULL, -- NULL if under a company plan
...
CREATE TABLE companies (
    ...
    subscription_tier ENUM('fleet_10','fleet_50','fleet_100_plus') NOT NULL,
...
## 10. Future Improvements (not required for v1)
...
### 10.1 Additional Ideas (not yet accepted — backlog for post-v1 review)
